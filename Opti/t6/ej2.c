...
void optimizeGaussianAdjust(int ***hist, double *alphas, double **mus, int x, int y, int z, double sigma, int n){
  ...
  {
    printf("\n\n\nalp\n");
    doglegOptimize_alpha(hist, x, y, z, alphas, mus, sigma, n, 1000, 1E-4, 10);
    printf("\n\n\nCH1\n");
    doglegOptimize_mu(hist, x, y, z, alphas, mus, sigma, n, 1000, 1E-8, 10, 0);

    printf("\n\n\nCH2\n");
    doglegOptimize_mu(hist, x, y, z, alphas, mus, sigma, n, 1000, 1E-6, 10, 1);

    printf("\n\n\nCH3\n");
    doglegOptimize_mu(hist, x, y, z, alphas, mus, sigma, n, 1000, 1E-6, 10, 2);
    // double fx = gaussianAdjust(hist, x, y, z, alphas, mus, sigma, n);
    // if(fx < 1E-8) break;
    // if()
  }
